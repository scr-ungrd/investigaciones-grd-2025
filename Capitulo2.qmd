...
format:
  html:
    ...
    include-in-header:
      - text: |
          <meta name="citation_title" content="Enfoque Etnodiferencial y Riesgo de Desastre en Colombia: Líneas de Fuga para una Digna Vida">
          <meta name="citation_author" content="Gaviria-Gutiérrez, William Oswaldo">
          <meta name="citation_author" content="Zambrano-Hernández, Lina Andrea">
          ...
          <meta name="citation_doi" content="10.5281/zenodo.17673252">
          ...
          <meta name="citation_abstract_html_url" content="https://scr-ungrd.github.io/investigaciones-grd-2025/Capitulo2.html">
          <meta name="citation_language" content="es">
          <meta name="citation_keywords" content="subalternización; gestión del riesgo de desastres; etnodiferencial; diversidad; justicia; comunidades; enfoque construccionista">
  pdf:
...
Gaviria-Gutiérrez, W. O., & Zambrano-Hernández, L. A. (2025). Enfoque etnodiferencial y riesgo de desastre en Colombia: líneas de fuga para una digna vida. En Comisión Nacional Asesora para la Investigación en Gestión del Riesgo de Desastres (Ed.), *Investigaciones en gestión del riesgo de desastres para Colombia. Enfoque comunitario, territorial y animal* (Cap. 2). Unidad Nacional para la Gestión del Riesgo de Desastres. https://doi.org/10.5281/zenodo.17673252

**Importar cita (BibTeX)**

``` bibtex
@incollection{gaviria2025,
  author    = {Gaviria-Gutiérrez, William Oswaldo and Zambrano-Hernández, Lina Andrea},
  title     = {Enfoque Etnodiferencial y Riesgo de Desastre en Colombia: Líneas de Fuga para una Digna Vida},
  ...
  chapter   = {2},
  doi       = {10.5281/zenodo.17673252},
  url       = {https://scr-ungrd.github.io/investigaciones-grd-2025/Capitulo2.html}
}
```

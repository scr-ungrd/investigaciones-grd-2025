...
1.  Establecer desde el inicio de proyectos de mapeo comunitario una gobernanza compartida que incluya a representantes de la comunidad, autoridades técnicas locales (DAGRD u otras entidades de gestión del riesgo) y organizaciones facilitadoras, para garantizar que los datos generados respondan tanto a necesidades comunitarias como a criterios técnicos institucionales.
2.  Diseñar protocolos de recolección de datos que cumplan con estándares técnicos de las instituciones responsables de la gestión del riesgo, pero que sean accesibles y comprensibles para las comunidades, asegurando su aplicabilidad tanto para la autogestión comunitaria como para procesos oficiales de monitoreo y respuesta.
3.  Implementar estrategias de diversificación del liderazgo comunitario y ampliar la base de participantes, considerando factores como edad, género, ocupación, alfabetización digital y acceso a tecnología, para garantizar la sostenibilidad y representatividad de los proyectos de mapeo a largo plazo.
4.  Establecer mecanismos de capacitación continua y acompañamiento técnico que permitan a las comunidades mantener y actualizar las bases de datos geográficas de manera autónoma, promoviendo la apropiación del conocimiento y la replicabilidad de metodologías en otros territorios o problemáticas.
5.  Garantizar que la información generada en proyectos de mapeo comunitario se aloje en plataformas abiertas e interoperables (como OpenStreetMap), siguiendo los principios FAIR, para facilitar su acceso, reutilización y actualización por parte de múltiples actores, trascendiendo cambios políticos y administrativos.
6.  Desarrollar productos de comunicación y visualización de datos que sean culturalmente pertinentes y accesibles para diferentes audiencias, con el fin de facilitar la socialización de resultados y la toma de decisiones informadas tanto a nivel comunitario como institucional.
:::

...
![Amenazas por movimiento en masa en Medellín, localizando el corregimiento de San Antonio de Prado. Creación propia. Datos tomados del catálogo geográfico de Medellín.](images/capitulo3/amenazas-san-antonio.png){#fig-amenazas-medellin width="500"}
...
![Capacitación en OSM con miembros del casco urbano de San Antonio de Prado y representante de equipo social del DAGRD en el Centro de Desarrollo Social (CDS) (octubre 2023).](images/capitulo3/capacitacion-osm.jpg){#fig-capacitacion-osm width="500"}
...
![Área delimitada para mapeo con dron basado en registros comunitarios de amenazas de deslizamiento.](images/capitulo3/area-delimitada-dron.png){#fig-area-mapeo-dron width="500"}
...
![Clasificación de alturas de las áreas de interés: izquierda; polígono de mapeo con zonas alta, media y baja (2185-2085 m, 2085-1985 m, 1965-1865 m, respectivamente). Derecha: Ortofoto de referencia.](images/capitulo3/clasificacion-alturas.png){#fig-clasificacion-alturas width="500"}
...
![Edición de OpenStreetMap en Id Editor utilizando la Ortofoto generada y las fotografías de Mapillary vinculadas a la misma plataforma (puntos verdes).](images/capitulo3/edicion-osm.png){#fig-edicion-osm width="500"}
...
![Registros (en naranja) de percepción de amenaza de deslizamiento tomados por la comunidad usando KoboToolbox.](images/capitulo3/registros-amenaza.png){#fig-registros-amenaza width="500"}
...
![Mapas de aspecto, pendiente e Índice topográfico de humedad generados a partir de las ortofotos creadas en el proyecto.](images/capitulo3/mapas-variables.png){#fig-mapas-variables width="500"}
...
![Caracterización de la localidad en relación con su topografía. Del lado izquierdo: Edificaciones mapeadas en café sobre la capa de índice topográfico de humedad (ITH). Las flechas negras señalan los valores altos del ITH en cordones de árboles, señalados también en la imagen de la derecha. Abajo, de ver el perfil topográfico de la zona en un corte vertical.](images/capitulo3/caracterizacion-topografia.png){#fig-caracterizacion-localidad width="500"}

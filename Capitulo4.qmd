...
author:
  - name: Evelin Langebeck Cuéllar
    affiliation: "^1^ Facultad de Ingeniería y Arquitectura. Universidad Católica de Manizales. Carrera 23 No. 60–63. Manizales, Caldas, Colombia"
    orcid: 0000-0003-2243-0899
  - name: Nicolás Giraldo Hernández ^1^
    corresponding: true
    email: giraldohnicolas@gmail.com
date: "2025-12-03"
...
format:
  html:
    ...
    include-in-header:
      - text: |
          <meta name="citation_title" content="Evaluación Multitemporal de la Resiliencia Comunitaria ante Eventos Tecnológicos en la Comuna 10 del Municipio de Dosquebradas">
          <meta name="citation_author" content="Langebeck Cuéllar, Evelin">
          <meta name="citation_author" content="Giraldo Hernández, Nicolás">
          ...
          <meta name="citation_doi" content="10.5281/zenodo.17673426">
          ...
          <meta name="citation_abstract_html_url" content="https://scr-ungrd.github.io/investigaciones-grd-2025/Capitulo4.html">
          <meta name="citation_language" content="es">
          <meta name="citation_keywords" content="community resilience; technological risk; ARC-D tool; disaster risk management; multi-temporal resilience; risk perception">
  pdf:
...
<h2 style="font-size: 1rem; margin-top: 0; margin-bottom: 0;"> Caja 2. Etapas de la herramienta ARC-D de GOAL y glosario de términos </h2>
...
<h2 style="font-size: 1rem; margin-top: 0; margin-bottom: 0;"> Caja 3. Glosario de términos relacionados con el riesgo tecnológico [@planmun2020]. </h2>
...
#| fig-height: 7
#| code-fold: true
#| code-summary: "<i class='bi bi-code-slash'></i> Código"

library(plotly)

categorias <- c(
  "1. Evaluación comunitaria", "2. Evaluación científica del riesgo",
  "3. Diseminación de información en RRD", "4. Educación de los niños en RRD",
  "5. RRD en la planificación del desarrollo", "6. RRD en la planificación territorial",
  "7. Toma comunitaria de decisiones", "8. Inclusión de grupos vulnerables",
  "9. Participación de las mujeres", "10. Conocimiento de derechos",
  "11. Alianzas para la RRD", "12. Gestión ambiental sostenible",
  "13. Seguridad y gestión del agua", "14. Acceso y conciencia de la salud",
  "15. Suministro seguro de alimentos", "16. Prácticas de medios de vida",
  "17. Acceso a mercado", "18. Acceso a servicios financieros",
  "19. Protección de ingresos y activos", "20. Acceso a protección social",
  "21. Cohesión social", "22. Infraestructura crítica", "23. Vivienda",
  "24. Planificación de contingencia", "25. Sistema de alerta temprana",
  "26. Capacidad de preparación", "27. Servicios de salud",
  "28. Servicios de educación", "29. Infraestructura en emergencias",
  "30. Liderazgo y voluntariado"
)

valores_2011 <- c(3, 2, 2, 2, 1, 1, 1, 2, 2, 2, 1, 2, 2, 2, 2, 1, 1, 1.2, 2, 2, 4, 1, 1, 1, 1, 2, 2, 2, 1, 1)

plot_ly(
  type = "scatterpolar",
  r = c(valores_2011, valores_2011[1]),
  theta = c(categorias, categorias[1]),
  fill = "toself",
  fillcolor = "rgba(255,235,100,0.5)",
...
valores_2021 <- c(4, 4, 3, 4, 3, 2, 1, 4, 3, 5, 4, 4, 3, 4, 4, 4, 2, 3, 2, 2, 3, 2, 3, 3, 3, 4, 4, 4, 4, 1)

plot_ly(
  type = "scatterpolar",
  r = c(valores_2021, valores_2021[1]),
  theta = c(categorias, categorias[1]),
  fill = "toself",
...
plot_ly() |>
  add_trace(
    ...
    theta = c(categorias, categorias[1]),
    fill = "toself",
    fillcolor = "rgba(255,235,100,0.4)",
    line = list(color = "goldenrod", width = 2),
    mode = "lines",
    name = "2011 (30.8%)"
  ) |>
...
Langebeck Cuéllar, E., & Giraldo Hernández, N. (2025). Evaluación multitemporal de la resiliencia comunitaria ante eventos tecnológicos en la Comuna 10 del municipio de Dosquebradas. En Comisión Nacional Asesora para la Investigación en Gestión del Riesgo de Desastres (Ed.), *Investigaciones en gestión del riesgo de desastres para Colombia. Enfoque comunitario, territorial y animal* (Cap. 4). Unidad Nacional para la Gestión del Riesgo de Desastres. https://doi.org/10.5281/zenodo.17673426

**Importar cita (BibTeX)**

``` bibtex
@incollection{langebeck2025,
  author    = {Langebeck Cuéllar, Evelin and Giraldo Hernández, Nicolás},
  title     = {Evaluación Multitemporal de la Resiliencia Comunitaria ante Eventos Tecnológicos en la Comuna 10 del Municipio de Dosquebradas},
  ...
  chapter   = {4},
  doi       = {10.5281/zenodo.17673426},
  url       = {https://scr-ungrd.github.io/investigaciones-grd-2025/Capitulo4.html}
}
```

...
format:
  html:
    ...
    include-in-header:
      - text: |
          <meta name="citation_title" content="Gestión del Riesgo Volcánico con Animales de Producción">
          <meta name="citation_author" content="Hernández Pulido, Diego">
          <meta name="citation_author" content="Lema Vélez, Julia Inés">
          <meta name="citation_publication_date" content="2025/12/03">
          <meta name="citation_online_date" content="2025/12/03">
          <meta name="citation_book_title" content="Investigaciones en Gestión del Riesgo de Desastres para Colombia. Enfoque Comunitario, Territorial y Animal">
          <meta name="citation_publisher" content="Unidad Nacional para la Gestión del Riesgo de Desastres - UNGRD">
          <meta name="citation_doi" content="10.5281/zenodo.17673444">
          <meta name="citation_pdf_url" content="https://scr-ungrd.github.io/investigaciones-grd-2025/Investigaciones-en-Gesti%C3%B3n-del-Riesgo-de-Desastres-para-Colombia.-Enfoque-Comunitario,-Territorial-y-Animal.pdf">
          <meta name="citation_abstract_html_url" content="https://scr-ungrd.github.io/investigaciones-grd-2025/Capitulo5.html">
          <meta name="citation_language" content="es">
          <meta name="citation_keywords" content="desastres; reducción de riesgo; ganadería; volcanes; animales de producción; bienestar animal; seguridad alimentaria">
  pdf:
...
**Palabras clave**: Desastres\index{Desastres}, reducción de riesgo\index{Reducción del riesgo}, ganadería\index{Ganadería}, volcanes\index{Volcanes}, animales de producción\index{Animales de producción}
:::
...
<h2 style="font-size: 1rem; margin-top: 0; margin-bottom: 0;"> Caja 2. Acceso desigual a capitales clave </h2>
...
**Capital humano**\index{Capital humano}: Permite desarrollar diferentes estrategias para desarrollar sus objetivos. Ej: Competencias, conocimiento, capacidad de trabajo y salud.

**Capital social**\index{Capital social}: Redes e interconexiones que incrementan la capacidad de trabajo y amplían el acceso a instituciones mayores. (i.e., pertenencia a grupos formalizados, relaciones de confianza).

**Capital natural**\index{Capital natural}: Los recursos y las reservas naturales de las que dependen las personas tales como tierras, bosques y otros.

**Capital físico**\index{Capital físico}: Infraestructuras básicas y bienes de producción, entre los que se incluyen: refugios, edificios, herramientas, equipos, semillas, ganado, transporte y comunicaciones.

**Capital financiero**\index{Capital financiero}: Disponibilidad de efectivo o equivalente, que permite a las personas adoptar diferentes estrategias en relación con los medios de vida: ahorros, capitales líquidos (ganado y joyas), créditos, pensiones o giros.

**Estrategia de los medios de vida**\index{Estrategia de los medios de vida}: Son aquellas actividades y decisiones que toman los hogares o las personas para combinar los capitales disponibles para alcanzar sus objetivos y mantener o reforzar sus medios de vida; o para hacer frente a las necesidades básicas. Ej: la agricultura, pesca, comercio, empleo público [@fao2015].
:::

### 2.3 Impacto sobre el sector de la producción animal\index{Producción animal}
...
### 2.4 Cómo afecta la ceniza a los animales de producción\index{Ceniza, efecto sobre animales de producción}
...
**Seguridad alimentaria**\index{Seguridad alimentaria de los animales de producción}: Los animales de producción son una fuente esencial de alimentos, y su pérdida a causa de desastres puede tener graves consecuencias para la seguridad alimentaria. La gestión de los sistemas de producción animal en la respuesta a desastres puede ayudar a garantizar que las comunidades afectadas dispongan de un suministro adecuado de alimentos, tanto a corto como a largo plazo.

**Medios de subsistencia**\index{Medios de subsistencia de los animales de producción}: La gestión de estos sistemas de producción suele ser una importante fuente de ingresos para muchas personas, sobre todo en las zonas rurales. Los desastres pueden tener un grave impacto en los medios de subsistencia de estas comunidades, y una gestión eficaz en la respuesta a desastres puede ayudar a minimizar el impacto en sus medios de subsistencia. Ganadería sostenible = alimentos hoy + recursos mañana + comunidades fuertes.

**Salud pública**\index{Salud pública de los animales de producción}: El ganado puede suponer un riesgo para la salud pública durante los desastres, principalmente si no se gestiona adecuadamente. Una gestión eficaz en la respuesta a desastres puede ayudar a prevenir la propagación de enfermedades y minimizar el riesgo de enfermedades zoonóticas.

**Gestión medioambiental**\index{Gestión medioambiental de los animales de producción}: La gestión de los animales en la respuesta a desastres puede ayudar a minimizar el impacto medioambiental, principalmente si el escenario ha provocado la liberación de materiales peligrosos [@wap2023].

::: {#caja3 .callout-important style="background-color: #e3f0fbff; border-left: 4px solid #d4e8f9ff;" appearance="minimal" icon="false"}
<h2 style="font-size: 1rem; margin-top: 0; margin-bottom: 0;"> Caja 3. Definiciones </h2>

**Zoonosis.**\index{Zoonosis} Una zoonosis es una enfermedad infecciosa que ha pasado de un animal a humanos. Los patógenos zoonóticos pueden ser bacterias, virus, parásitos o agentes no convencionales y propagarse a los humanos por contacto directo o a través de los alimentos, el agua o el medio ambiente. Representan un importante problema de salud pública en todo el mundo debido a nuestra estrecha relación con los animales en el medio agrícola, la vida cotidiana (animales de compañía) y el entorno natural. Las zoonosis también pueden causar alteraciones en la producción y el comercio de productos de origen animal destinados a la alimentación y otros usos.

**Epizootias.**\index{Epizootias} Según la Organización mundial de sanidad animal, las epizootias son enfermedades que abordan una o varias especies de animales por una causa general y transitoria, y que equivale a la epidemia en el ser humano [@fao_woah2015].
:::
...
### 3.2 Efecto sobre las pasturas\index{Pasturas, efecto de la caída de ceniza}
...
### 3.3 Efectos en la silvicultura\index{Silvicultura, efecto de la caída de ceniza}
...
### 3.4 Efectos en los cultivos herbáceos\index{Cultivos herbáceos, efecto de la caída de ceniza}
...
## 4. REDUCCIÓN DEL RIESGO VOLCÁNICO EN ANIMALES DE PRODUCCIÓN\index{Reducción del riesgo vulcánico en animales de producción}
...
![Evacuación y movilización de ganado vacuno durante la erupción del volcán Chaitén, Chile 2008. Fuente: Diego Hernández Pulido.](images/capitulo5/evacuacion-ganado-chaitén.jpg){#fig-evacuacion width="450"}

## 5. MANEJO DE DESASTRES EN ANIMALES DE PRODUCCIÓN\index{Manejo de desastres en animales de producción}
...
::: {#caja4 .callout-important style="background-color: #e3f0fbff; border-left: 4px solid #d4e8f9ff;" appearance="minimal" icon="false"}
<h2 style="font-size: 1rem; margin-top: 0; margin-bottom: 0;"> Caja 4. Guía LEGS para intervenciones ganaderas\index{Guía LEGS para intervenciones ganaderas} </h2>
...
::: {#caja5 .callout-important style="background-color: #e3f0fbff; border-left: 4px solid #d4e8f9ff;" appearance="minimal" icon="false"}
<h2 style="font-size: 1rem; margin-top: 0; margin-bottom: 0;"> Caja 5. Intoxicación del ganado por ceniza volcánica con flúor.\index{Intoxicación del ganado por ceniza volcánica con flúor} </h2>
...
-   Las actividades de preparación, respuesta y recuperación aplicadas a sistemas de producción animal en escenarios de erupciones volcánicas facilitan la supervivencia de los animales y la resiliexncia de sus propietarios.
...
Hernández Pulido, D., & Lema Vélez, J. I. (2025). Gestión del riesgo volcánico con animales de producción. En Comisión Nacional Asesora para la Investigación en Gestión del Riesgo de Desastres (Ed.), *Investigaciones en gestión del riesgo de desastres para Colombia. Enfoque comunitario, territorial y animal* (Cap. 5). Unidad Nacional para la Gestión del Riesgo de Desastres. https://doi.org/10.5281/zenodo.17673444

**Importar cita (BibTeX)**

``` bibtex
@incollection{hernandezpulido2025,
  author    = {Hernández Pulido, Diego and Lema Vélez, Julia Inés},
  title     = {Gestión del Riesgo Volcánico con Animales de Producción},
  booktitle = {Investigaciones en Gestión del Riesgo de Desastres para Colombia. Enfoque Comunitario, Territorial y Animal},
  editor    = {{Comisión Nacional Asesora para la Investigación en Gestión del Riesgo de Desastres (CNAIGRD)}},
  publisher = {Unidad Nacional para la Gestión del Riesgo de Desastres (UNGRD)},
  address   = {Bogotá, Colombia},
  year      = {2025},
  chapter   = {5},
  doi       = {10.5281/zenodo.17673444},
  url       = {https://scr-ungrd.github.io/investigaciones-grd-2025/Capitulo5.html}
}
```
